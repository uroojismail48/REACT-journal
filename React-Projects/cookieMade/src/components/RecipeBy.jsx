...
fetchData()
  ...
  return (
    <div>
        <div className="border border-black p-4 mt-5 flex justify-center items-center text-center flex-col">
            <h2 className="font-bold text-4xl">Find Recipes By Category</h2>
            <div className="flex gap-2 w-full items-center mt-6 justify-center  ">
